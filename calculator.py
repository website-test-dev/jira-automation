...
class Calculator:
    ...
    def divide(self, a, b):
        ...
        If b is zero, prints an error message and returns None instead of raising an exception.
        """
        if b == 0:
    ...
    def run_tests(self):
        ...
        # Example division test (normal case)
        print(f"10 / 2 = {self.divide(10, 2)}")
        # Example division test (zero divisor)
        self.divide(10, 0)
